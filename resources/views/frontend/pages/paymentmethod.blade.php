				...
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li class="active"><a href="javascript:void(0);">Payment Methods</a></li>
						</ul>
					</div>
				</div>
			</div>
						...
						<div class="col-lg-8 col-12">
							<div class="form-main">
								<div class="title">
									...
									<h3>The use of this website is subject to the following terms of use:@auth @else<span style="font-size:12px;" class="text-danger">[You need to login first]</span>@endauth</h3>
								</div>
                                <style>
</style>
								<ul>
                                
<li>- The content of the pages of this website is for your general information and use only. It is subject to change without notice.</p>
</li>
...
<li>- Trade marks, if any, reproduced in this website which are not the property of, or licensed to, the operator are acknowledged on the website.
...
<li>- These Terms and Conditions are governed by and construed in accordance with the laws of the India and any dispute relating thereto shall be subject to the non-exclusive jurisdiction of the courts of Mumbai.
</li>
</ul>  
							</div>
						</div>
